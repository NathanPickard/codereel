...
class CodeReelPanel {
    ...
    static createOrShow(_extensionUri, functionName) {
        if (CodeReelPanel.instance) {
            CodeReelPanel.instance.panel.reveal(vscode.ViewColumn.Beside);
            return CodeReelPanel.instance;
        }
        const panel = vscode.window.createWebviewPanel('codereel', `CodeReel: ${functionName}`, vscode.ViewColumn.Beside, {
            enableScripts: true,
...
function renderHtml(storyboard, code) {
